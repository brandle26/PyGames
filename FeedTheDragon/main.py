...
# set fonts
font = pygame.font.Font("resources\AttackGraffiti.ttf", 32)
...
pygame.mixer.music.load(r"resources\ftd_background_music.wav")

# set images
player_image = pygame.image.load("resources\dragon_right.png")
