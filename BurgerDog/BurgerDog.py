...
#Set Fonts
font=pygame.font.Font("resources\WashYourHand.ttf",32)
...
bark_sound=pygame.mixer.Sound(r"resources\bark_sound.wav")
miss_sound=pygame.mixer.Sound(r"resources\miss_sound.wav")
pygame.mixer.music.load(r"resources\bd_background_music.wav")


#Set images
player_image_right=pygame.image.load(r"resources\dog_right.png")
player_image_left=pygame.image.load(r"resources\dog_left.png")
...
burger_image=pygame.image.load(r"resources\burger.png")
...
while running:
    ...
    if player_lives==0:
        ...
        #Pause the game until the player press a key then reset the game
